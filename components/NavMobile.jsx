...
import {FaUsers, FaImages, FaLocationArrow } from 'react-icons/fa'
        ...
        <div className="flex flex-col items-center justify-between h-full">
          ...
          <div className="flex flex-col gap-y-8">
            {links.map((link, index) => {
              return (
              <Link  onClick={() => setIsOpen(false)} key={index} href={link.path} offset={link.offset} smooth='false' className="flex items-center gap-x-3">
