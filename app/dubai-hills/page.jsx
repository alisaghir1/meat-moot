...
import dubaiHillsTrans from '../translation/dubaiHillsTrans.js';
...
const Page = () => {
  ...
  const t = dubaiHillsTrans[language]; // Get translations based on language
      ...
      <div className='flex flex-col justify-center text-center items-center'>
        ...
        <div className='flex flex-col justify-center items-center my-20 text-white gap-5'>
          ...
          <h2 className='underline'>
              ...
              <Button className='w-30 border border-orange hover:bg-black hover:text-white' variant='orange'>{t.get_directions}</Button>
            </Link>
          </h2>
          <h2 className='underline'>
            <Link  href="tel:+9710581264843">
              <Button className='w-30 border border-orange hover:bg-orange hover:text-white' variant='black'>{t.call_us}</Button>
            </Link>
          </h2>
          </div>
