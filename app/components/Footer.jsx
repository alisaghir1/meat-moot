      ...
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          <div className="mt-6 lg:max-w-sm">
            <p className="text-sm text-white">
              Delivering exceptional service and quality with every bite.
              Experience the finest in dining, prepared with passion and care.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="mt-4 text-sm text-white">
            Follow us on social media to stay up-to-date with our latest dishes,
