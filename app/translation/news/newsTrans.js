...
const newsTrans = {
  en: {
    ...
    news: [
      ...
      },
      {
        ...
        translatedTitle: "Ertugrul Cast Visiting Meat Moot Restaurant"
      },
      {
        title: "Arab Stars Visit Meat Moot Restaurant",
        translatedTitle: "Arab Stars Visit Meat Moot Restaurant"
      },
      {
  ...
  ar: {
    ...
    news: [
      ...
      {
        title: "Ertugrul Cast Visiting Meat Moot Restaurant",
        translatedTitle: "طاقم أرطغرل يزور مطعم ميت موت"
      },
      {
        title: "Arab Stars Visit Meat Moot Restaurant",
        translatedTitle: "النجوم العرب يزورون مطعم ميت موت"
      },
      {
        title: "Meat Moot - Renowned Smoked Meat Restaurant Expands to Dubai, Celebrates Grand Opening",
  ...
  ru: {
    ...
    news: [
      ...
      {
        title: "Arab Stars Visit Meat Moot Restaurant",
        translatedTitle: "Арабские звёзды посещают ресторан Мит Мут"
      },
      {
        title: "Meat Moot - Renowned Smoked Meat Restaurant Expands to Dubai, Celebrates Grand Opening",
