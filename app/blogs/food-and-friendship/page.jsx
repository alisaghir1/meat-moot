...
import foodFriendshipTrans from '../../translation/blogs/foodFriendshipTrans';

const FoodAndFriendship = () => {
  const [languege] = useAppContext();
  const data = foodFriendshipTrans[languege] || foodFriendshipTrans.en;
...
export default FoodAndFriendship;
