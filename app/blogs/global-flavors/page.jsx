    ...
    <div className="max-w-screen-2xl mx-auto p-5 sm:p-10 md:p-16 relative mt-32">
      ...
      >
        <h1 className="text-orange font-bold text-center text-4xl mb-6">
          {globalFlavorsTrans[languege].title}
        </h1>
      </motion.div>
      ...
      >
        <img
          ...
          alt={globalFlavorsTrans[languege].title}
      ...
      >
        {globalFlavorsTrans[languege].content.map((item, index) => (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
        ...
        >
          <img
            src="/blogs/blog1-2.jpg"
            alt="Global Flavors 2"
        ...
        >
          <img
            src="/blogs/blog1-4.jpg"
            alt="Global Flavors 4"
            className="w-full h-64 object-cover rounded-lg shadow-lg"
          />
        </motion.div>
      </div>
