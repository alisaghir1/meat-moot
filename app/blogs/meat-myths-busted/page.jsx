...
import meatMythsTrans from '../../translation/blogs/meatMythsTrans';

const MeatMythsBusted = () => {
  const [languege] = useAppContext();
  const data = meatMythsTrans[languege] || meatMythsTrans.en;
...
export default MeatMythsBusted;
